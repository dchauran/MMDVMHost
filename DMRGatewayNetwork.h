...
{
public:
	CDMRGatewayNetwork(const std::string& remoteAddress, unsigned short remotePort, const std::string& localAddress, unsigned short localPort, unsigned int id, unsigned int pingInterval, bool duplex, const char* version, bool slot1, bool slot2, HW_TYPE hwType, bool debug);
